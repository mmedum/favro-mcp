...
var errCustomFieldNotFound = render.Sentinel(render.ClassNotFound,
	"favro: custom field not found in active organization")

var errUnsupportedCustomFieldType = render.Sentinel(render.ClassUnsupported, "favro: custom-field type cannot be set by favro_set_card_custom_field")
...
func registerSetCardCustomField(reg *registry, r *service.Resolver) {
...
func lookupCustomFieldType(ctx context.Context, r *service.Resolver, customFieldID string, forceRefresh bool) (favro.CustomField, error) {
...
var setCFOptions = []setCFOption{
	{
		inputName: "text", fieldTypes: []string{service.CFTypeText},
	...
	},
	{
		...
		inputName: "number", fieldTypes: []string{service.CFTypeNumber},
	...
	{
		inputName: "date", fieldTypes: []string{service.CFTypeDate},
	...
	{
		inputName: "checkbox", fieldTypes: []string{service.CFTypeCheckbox},
	...
	{
		inputName: "vote", fieldTypes: []string{service.CFTypeVote, service.CFTypeVoting},
	...
	{
		inputName: "color", fieldTypes: []string{service.CFTypeColor},
	...
	},
	{
		...
		inputName: "single_select_item_id", fieldTypes: []string{service.CFTypeSingleSelect},
	...
	{
		inputName: "status_item_id", fieldTypes: []string{service.CFTypeStatus},
	...
	},
	{
		...
		inputName: "multi_select_item_ids", fieldTypes: []string{service.CFTypeMultipleSelect},
	...
	},
	{
		...
		inputName: "add_member_user_ids / remove_member_user_ids", fieldTypes: []string{service.CFTypeMembers},
	...
	},
	{
		...
		inputName: "add_tag_ids / remove_tag_ids", fieldTypes: []string{service.CFTypeTags},
		isSet: func(in *setCardCustomFieldInput) bool {
	...
	},
	{
		...
		inputName: "rating_value", fieldTypes: []string{service.CFTypeRating},
		isSet: func(in *setCardCustomFieldInput) bool { return in.RatingValue != nil },
		validate: func(in *setCardCustomFieldInput) error {
			if *in.RatingValue < 0 || *in.RatingValue > service.RatingMaxStars {
				return fmt.Errorf("rating_value must be between 0 and %d", service.RatingMaxStars)
			}
			return nil
		},
		apply: func(in *setCardCustomFieldInput, u *favro.CardCustomFieldUpdate) {
	...
	{
		inputName: "link_url", fieldTypes: []string{service.CFTypeLink},
	...
	{
		inputName: "timeline_start_date / timeline_due_date", fieldTypes: []string{service.CFTypeTimeline},
		isSet: func(in *setCardCustomFieldInput) bool {
	...
	},
	{
		...
		inputName: "time_report_ms", fieldTypes: []string{service.CFTypeTime},
