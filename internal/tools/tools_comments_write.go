...
func registerCreateComment(reg *registry, r *service.Resolver) {
...
func registerUpdateComment(reg *registry, r *service.Resolver) {
	addTool(reg, &mcp.Tool{
...
func registerDeleteComment(reg *registry, r *service.Resolver) {
	addTool(reg, &mcp.Tool{
