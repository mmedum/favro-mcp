...
func registerCreateColumn(reg *registry, r *service.Resolver) {
...
func registerUpdateColumn(reg *registry, r *service.Resolver) {
	addTool(reg, &mcp.Tool{
...
func registerDeleteColumn(reg *registry, r *service.Resolver) {
	addTool(reg, &mcp.Tool{
...
// re-warms lazily.
func invalidateColumnCacheScoped(r *service.Resolver, widgetCommonID string) {
	if widgetCommonID != "" {
