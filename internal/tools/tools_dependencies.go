...
func registerDependencies(reg *registry, client *favroapi.Client) {
	registerReadDependencies(reg, client)
	registerWriteDependencies(reg, client)
	registerDeleteDependencies(reg, client)
}

func registerReadDependencies(reg *registry, client *favroapi.Client) {
...
func registerWriteDependencies(reg *registry, client *favroapi.Client) {
	addTool(reg, &mcp.Tool{
...
func registerDeleteDependencies(reg *registry, client *favroapi.Client) {
	addTool(reg, &mcp.Tool{
