...
func registerResolveUser(reg *registry, r *service.Resolver) {
	...
	}, func(ctx context.Context, _ *mcp.CallToolRequest, in resolveUserInput) (*mcp.CallToolResult, resolveOutput[service.ResolvedUser], error) {
		matches, cached, err := r.ResolveUser(ctx, in.Name, in.Limit, in.ForceRefresh)
		if err != nil {
			return nil, resolveOutput[service.ResolvedUser]{}, err
		}
		return nil, resolveOutput[service.ResolvedUser]{Candidates: matches, Cached: cached}, nil
	})
}
